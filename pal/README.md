...
To port the Software Framework on you Host platfrom please follow this [guidance](https://github.com/Infineon/optiga-trust-charge/blob/master/documents/Porting_Guide.md). As a basis for your new PAL implementation, you can take this [template](NEW_PAL_TEMPLATE)
